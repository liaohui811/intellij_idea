...
module Kernel
    ...
    def self.test(int_cmd, file1, *file2)
        #This is a stub, used for indexing
    end
    ...
    def self.fork(*several_variants)
        #This is a stub, used for indexing
    end
    ...
    def self.scan(*several_variants)
        #This is a stub, used for indexing
    end
