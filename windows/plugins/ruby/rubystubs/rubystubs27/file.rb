...
class File < IO
    ...
    # names in the argument list.
    def self.lutime(atime, mtime, file_name, *smth)
        #This is a stub, used for indexing
    end
    ...
    module File::Constants
        ...
        FNM_NOESCAPE = nil #value is unknown, used for indexing.
        # Wildcards in File.fnmatch and Dir.glob patterns do not match directory
        # separators
        FNM_PATHNAME = nil #value is unknown, used for indexing.
        # The '*' wildcard matches filenames starting with "." in File.fnmatch
        # and Dir.glob patterns
        FNM_DOTMATCH = nil #value is unknown, used for indexing.
        # Makes File.fnmatch patterns case insensitive (but not Dir.glob
        # patterns).
        FNM_CASEFOLD = nil #value is unknown, used for indexing.
        # Allows file globbing through "{a,b}" in File.fnmatch patterns.
        FNM_EXTGLOB = nil #value is unknown, used for indexing.
        # System default case insensitiveness, equals to FNM_CASEFOLD or
        # 0.
        FNM_SYSCASE = nil #value is unknown, used for indexing.
        # Makes patterns to match short names if existing.  Valid only
        # on Microsoft Windows.
        FNM_SHORTNAME = nil #value is unknown, used for indexing.
        ...
        SHARE_DELETE = nil #value is unknown, used for indexing.
        ...
        TMPFILE = nil #value is unknown, used for indexing.
