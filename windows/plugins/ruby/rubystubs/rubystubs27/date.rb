...
class Date
    ...
    def self.weeknum(p1 = v1, p2 = v2, p3 = v3, p4 = v4, p5 = v5)
        #This is a stub, used for indexing
    end
    def self.nth_kday(p1 = v1, p2 = v2, p3 = v3, p4 = v4, p5 = v5)
        #This is a stub, used for indexing
    end
    ...
    def self.test_ordinal()
        #This is a stub, used for indexing
    end
    def self.test_commercial()
        #This is a stub, used for indexing
    end
    def self.test_weeknum()
        #This is a stub, used for indexing
    end
    def self.test_nth_kday()
        #This is a stub, used for indexing
    end
    def self.test_unit_conv()
        #This is a stub, used for indexing
    end
    def self.test_all()
        #This is a stub, used for indexing
