...
module Process
    ...
    # see Process.clock_gettime   
    CLOCK_MONOTONIC_RAW_APPROX = nil #value is unknown, used for indexing.
    # see Process.clock_gettime   
    ...
    # see Process.clock_gettime   
    CLOCK_UPTIME_RAW = nil #value is unknown, used for indexing.
    # see Process.clock_gettime   
    CLOCK_UPTIME_RAW_APPROX = nil #value is unknown, used for indexing.
    # see Process.clock_gettime   
    CLOCK_SECOND = nil #value is unknown, used for indexing.
    # see Process.clock_gettime   
    CLOCK_TAI = nil #value is unknown, used for indexing.
