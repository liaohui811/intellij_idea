...
class String
    ...
    # <code>each_line</code>.
    def lines(separator=$/, chomp: false)
        #This is a stub, used for indexing
    end
    # str.bytes    -> an_array
    # 
    ...
    def prepend(other_str1, other_str2, *smth)
        #This is a stub, used for indexing
    end
    ...
    def each_grapheme_cluster(*several_variants)
        #This is a stub, used for indexing
    end
