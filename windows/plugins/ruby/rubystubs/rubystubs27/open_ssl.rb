...
module OpenSSL
    ...
    module ASN1
        ...
        class Constructive < ASN1Data
            ...
            def initialize(p1, p2 = v2, p3 = v3, p4 = v4)
                #This is a stub, used for indexing
            end
            # asn1.to_der => DER-encoded String
            # 
    ...
    module PKey
        ...
        class EC < PKey
            ...
            EXPLICIT_CURVE = nil #value is unknown, used for indexing.
            ...
            class Point
                ...
                # - +:uncompressed+
                # - +:hybrid+
                def to_octet_string(conversion_form)
                    #This is a stub, used for indexing
                end
        ...
        class RSA < PKey
            ...
            def sign_pss(digest, data, salt_length:, mgf1_hash:)
                #This is a stub, used for indexing
            end
            ...
            def verify_pss(digest, signature, data, salt_length:, mgf1_hash:)
                #This is a stub, used for indexing
            end
    ...
    module SSL
        VERIFY_NONE = nil #value is unknown, used for indexing.
        VERIFY_PEER = nil #value is unknown, used for indexing.
        VERIFY_FAIL_IF_NO_PEER_CERT = nil #value is unknown, used for indexing.
        VERIFY_CLIENT_ONCE = nil #value is unknown, used for indexing.
        OP_ALL = nil #value is unknown, used for indexing.
        OP_LEGACY_SERVER_CONNECT = nil #value is unknown, used for indexing.
        OP_TLSEXT_PADDING = nil #value is unknown, used for indexing.
        OP_SAFARI_ECDHE_ECDSA_BUG = nil #value is unknown, used for indexing.
        OP_ALLOW_NO_DHE_KEX = nil #value is unknown, used for indexing.
        OP_DONT_INSERT_EMPTY_FRAGMENTS = nil #value is unknown, used for indexing.
        OP_NO_TICKET = nil #value is unknown, used for indexing.
        OP_NO_SESSION_RESUMPTION_ON_RENEGOTIATION = nil #value is unknown, used for indexing.
        OP_NO_COMPRESSION = nil #value is unknown, used for indexing.
        OP_ALLOW_UNSAFE_LEGACY_RENEGOTIATION = nil #value is unknown, used for indexing.
        OP_NO_ENCRYPT_THEN_MAC = nil #value is unknown, used for indexing.
        OP_CIPHER_SERVER_PREFERENCE = nil #value is unknown, used for indexing.
        OP_TLS_ROLLBACK_BUG = nil #value is unknown, used for indexing.
        OP_NO_RENEGOTIATION = nil #value is unknown, used for indexing.
        OP_CRYPTOPRO_TLSEXT_BUG = nil #value is unknown, used for indexing.
        OP_NO_SSLv3 = nil #value is unknown, used for indexing.
        OP_NO_TLSv1 = nil #value is unknown, used for indexing.
        OP_NO_TLSv1_1 = nil #value is unknown, used for indexing.
        OP_NO_TLSv1_2 = nil #value is unknown, used for indexing.
        OP_NO_TLSv1_3 = nil #value is unknown, used for indexing.
        OP_NO_QUERY_MTU = nil #value is unknown, used for indexing.
        OP_COOKIE_EXCHANGE = nil #value is unknown, used for indexing.
        OP_CISCO_ANYCONNECT = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.1.0.   
        OP_MICROSOFT_SESS_ID_BUG = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.1.0.   
        OP_NETSCAPE_CHALLENGE_BUG = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 0.9.8q and 1.0.0c.   
        OP_NETSCAPE_REUSE_CIPHER_CHANGE_BUG = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.0.1h and 1.0.2.   
        OP_SSLREF2_REUSE_CERT_TYPE_BUG = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.1.0.   
        OP_MICROSOFT_BIG_SSLV3_BUFFER = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 0.9.7h and 0.9.8b.   
        OP_MSIE_SSLV2_RSA_PADDING = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.1.0.   
        OP_SSLEAY_080_CLIENT_DH_BUG = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.1.0.   
        OP_TLS_D5_BUG = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.1.0.   
        OP_TLS_BLOCK_PADDING_BUG = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.1.0.   
        OP_SINGLE_ECDH_USE = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.1.0.   
        OP_SINGLE_DH_USE = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.0.1k and 1.0.2.   
        OP_EPHEMERAL_RSA = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.1.0.   
        OP_NO_SSLv2 = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.0.1.   
        OP_PKCS1_CHECK_1 = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.0.1.   
        OP_PKCS1_CHECK_2 = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.1.0.   
        OP_NETSCAPE_CA_DN_BUG = nil #value is unknown, used for indexing.
        # Deprecated in OpenSSL 1.1.0.   
        OP_NETSCAPE_DEMO_CIPHER_CHANGE_BUG = nil #value is unknown, used for indexing.
        # SSL 2.0   
        SSL2_VERSION = nil #value is unknown, used for indexing.
        # SSL 3.0   
        SSL3_VERSION = nil #value is unknown, used for indexing.
        # TLS 1.0   
        TLS1_VERSION = nil #value is unknown, used for indexing.
        # TLS 1.1   
        TLS1_1_VERSION = nil #value is unknown, used for indexing.
        # TLS 1.2   
        TLS1_2_VERSION = nil #value is unknown, used for indexing.
        # TLS 1.3   
        TLS1_3_VERSION = nil #value is unknown, used for indexing.
        ...
        class SSLContext
            ...
            def add_certificate(p1, p2, p3 = v3)
                #This is a stub, used for indexing
            end
        ...
        require 'wait_readable'
        class SSLErrorWaitReadable < SSLError
            include IO::WaitReadable
        end
        require 'wait_writable'
    ...
    module X509
        ...
        class ExtensionFactory
            def initialize(p1 = v1, p2 = v2, p3 = v3, p4 = v4)
                #This is a stub, used for indexing
            end
            ...
            def create_ext(*several_variants)
                #This is a stub, used for indexing
            end
        end
        ...
        class StoreContext
            ...
            def initialize(store, cert = nil, chain = nil)
                #This is a stub, used for indexing
            end
