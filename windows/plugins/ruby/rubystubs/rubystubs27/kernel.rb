...
module Kernel
    ...
    def self.raise(*several_variants)
        #This is a stub, used for indexing
    end
    # raise
    # raise(string, cause: $!)
    ...
    #    raise "Failed to create socket"
    #    raise ArgumentError, "No parameters", caller
    def self.fail(*several_variants)
        #This is a stub, used for indexing
    end
    ...
    #    $_ is now 'hello'
    #    $_ is now ' there'
    def self.trace_var(*several_variants)
        #This is a stub, used for indexing
    end
    ...
    def self.untrace_var(symbol, *cmd)
        #This is a stub, used for indexing
    end
    # at_exit { block } -> proc
    # 
    ...
    def self.BigDecimal(initial, digits, exception: true)
        #This is a stub, used for indexing
    end
    ...
    def self.printf(*several_variants)
        #This is a stub, used for indexing
    end
    # print(obj, ...)    -> nil
    # 
    ...
    def self.require_relative(string)
        #This is a stub, used for indexing
    end
    ...
    def self.autoload(module1, filename)
        #This is a stub, used for indexing
    end
    ...
    #    autoload(:B, "b")
    #    autoload?(:B)            #=> "b"
    def self.autoload?(name, inherit=true)
        #This is a stub, used for indexing
    end
    ...
    #   sprintf("%{foo}f", { :foo => 1 })
    #     # => "1f"
    def self.format(format_string, *args)
        #This is a stub, used for indexing
    end
    ...
    def self.Integer(arg, base=0, exception: true)
        #This is a stub, used for indexing
    end
    ...
    def self.Float(arg, exception: true)
        #This is a stub, used for indexing
    end
    # String(arg)   -> string
    # 
    ...
    def self.Rational(*several_variants)
        #This is a stub, used for indexing
    end
    ...
    # Available only when -p/-n command line option specified.
    def self.gsub(*several_variants)
        #This is a stub, used for indexing
    end
    # chop   -> $_
    # 
    ...
    # String#chomp.
    # Available only when -p/-n command line option specified.
    def self.chomp(*several_variants)
        #This is a stub, used for indexing
    end
    ...
    #    c(4)   #=> []
    #    c(5)   #=> nil
    def self.caller(*several_variants)
        #This is a stub, used for indexing
    end
    ...
    # Optionally you can pass a range, which will return an array containing the
    # entries within the specified range.
    def self.caller_locations(*several_variants)
        #This is a stub, used for indexing
    end
    ...
    def self.eval(string, *binding_filename_lineno)
        #This is a stub, used for indexing
    end
    ...
    #      puts enum.next
    #    } #=> :ok
    def self.loop(*several_variants)
        #This is a stub, used for indexing
    end
    ...
    def self.set_trace_func(*several_variants)
        #This is a stub, used for indexing
    end
    ...
    # ArgumentError:: If the +initial+ is a Float or Rational, and the +digits+
    #                 value is omitted, this exception is raised.
    def BigDecimal(initial, digits, exception: true)
        #This is a stub, used for indexing
    end
    # Pathname(path)  -> pathname
    # 
